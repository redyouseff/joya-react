    ...
    <>
      <FadeInSection>
        <div className="px-4 lg:px-0 flex items-center justify-center mt-10 mb-10">
          <div className="max-w-3xl p-6 bg-[#04453d] rounded-3xl shadow-lg text-center text-[#faf8f7]">
      ...
      <FadeInSection>
        <div className="text-[#faf8f7] p-6 my-10 rounded-2xl bg-[#111612]">
  ...
  <div className="space-y-4">
    ...
    <div>
      <div className="flex items-center justify-between">
        <input className="w-1/2 bg-[#022b29] text-white px-4 py-2 rounded-md" type="text" value={value.toLocaleString()} onChange={onChange} />
...
const Modal = ({ onClose }) => (
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 transition-all duration-200">
    <div className="bg-[#404740] text-[#faf8f7] w-[550px] rounded-lg shadow-lg p-6 relative animate-fade-in-fast">
      ...
      <div className="flex justify-between border-b border-gray-600 py-2">
        ...
        <span>1,176,580 AED</span>
      </div>
      <div className="flex justify-between border-b border-gray-600 py-2">
        <span>Trustee Office Fee</span>
        <span>4,200 AED</span>
      </div>
      <div className="text-xs text-[#f0ede6] mt-4">
        *This calculator is for illustration purposes only. Exact figures will be provided with your mortgage offer.
      </div>
    </div>
  </div>
);
